        ...
        - image: "cybwan/osm-edge-demo-rest2grpc:latest"
          ...
          ports:
            - name: user-port
              ...
              protocol: TCP
          command: ["java"]
          args: ["-Xmx2g","-jar","/client-0.0.1.jar","-Dspring.config.location=application-client.yml","--spring.profiles.active=client","-XX:InitialRAMPercentage=80.0","-XX:MaxRAMPercentage=80.0","-XX:MaxMetaspaceSize=100m"]
          env:
            - name: IDENTITY
